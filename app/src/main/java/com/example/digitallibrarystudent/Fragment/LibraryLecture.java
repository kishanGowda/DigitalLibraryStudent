...
import com.example.digitallibrarystudent.Adapters.LecturerAdapterTwo;
...
public class LibraryLecture extends Fragment {
    ...
    public LibraryLecture(int topicId, int chapterId) {
    ...
    public void getLibrary(){
        Call<GetLibraryResponse> call=loginService.getLibraryCall_notes(topicId,chapterId,"lecture-notes");
